...
export default function CreateAccount() {
  ...
  const handleSubmit = () => {
    ...
    localStorage.setItem("chatUser", JSON.stringify({ username: `${form.firstName} ${form.lastName}` }));
          ...
          <div className="w-full md:w-96 bg-white rounded-2xl p-8 shadow-md border border-gray-100">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="relative">
                {/* Checklist popup - above the input */}
                {form.password.length > 0 && (
                  <div className="absolute bottom-full mb-2 left-0 w-full bg-white border border-gray-200 rounded-lg shadow-lg p-3 text-xs space-y-1 z-10">
                    {/* Arrow pointing down */}
                    <div className="absolute -bottom-2 left-4 w-3 h-3 bg-white border-r border-b border-gray-200 rotate-45" />
