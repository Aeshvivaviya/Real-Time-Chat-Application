...
function Sidebar({
  ...
  return (
    <div className="w-72 bg-gradient-to-b from-gray-900 to-black border-r border-gray-800/50 flex flex-col">
      ...
      <div className="p-6 border-b border-gray-800">
        <h3 className="text-white font-bold text-lg flex items-center gap-2">
          <span
            className={`w-3 h-3 rounded-full ${
              onlineCount > 0 ? "bg-green-500" : "bg-gray-500"
            }`}
          ></span>
          Users
        </h3>
        ...
        <input
          ...
          className="mt-3 w-full px-3 py-2 bg-gray-800 text-white rounded"
        />
      </div>
